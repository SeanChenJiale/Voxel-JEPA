...
from app_scratch.vjepa.utils import (
    load_checkpoint,
    init_video_model,
    init_opt,
)
from app_scratch.vjepa.transforms import make_transforms
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        for itr in range(ipe):
            ...
            def load_clips():
                ...
                _masks_enc, _masks_pred = [], [] ## we leave this function be for scratch
                return (clips, _masks_enc, _masks_pred)
                
            clips, _, _ = load_clips() # we just ignore the masks_enc as this is a scratch model, 
